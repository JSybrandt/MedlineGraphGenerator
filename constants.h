...
//const char* LVG_COMMAND = "/scratch2/jsybran/lvgCommand.sh";
...
const std::string FASTTEXT_COMMAND = "fasttext skipgram -dim 500 -ws 8 -maxn 8 -thread 12 -input " + CANON_FILE + " -output " + CANON_FILE;
